...
class CollectionCommand(BaseCommand):
    ...
    def register_args(self, parser: argparse.ArgumentParser):
        ...
        delete_p.add_argument("--version", type=int, help="Collection version (optional if recursive)")
        delete_p.add_argument("--recursive", action="store_true", help="Delete all items and sub-collections")
        ...
        # Clean
        clean_p = sub.add_parser("clean", help="Empty all items from a collection (Does not delete collection)")
        ...
        dupe_p.add_argument("--collections", required=True, help="Comma-separated list of collection names or keys")
