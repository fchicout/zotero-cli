...
class TagRepository(ABC):
    ...
    @abstractmethod
    def add_tags(self, item_key: str, tags: List[str]) -> bool: pass
...
class MetadataProvider(ABC):
    @abstractmethod
    def get_paper_metadata(self, identifier: str) -> Optional[ResearchPaper]: pass

class ArxivGateway(ABC):
    @abstractmethod
    def search(self, query: str, max_results: int = 100, sort_by: str = "relevance", sort_order: str = "descending") -> Iterator[ResearchPaper]: pass
