...
@pytest.fixture
def service(
    mock_repo, mock_collection_repo, mock_note_repo, mock_tag_repo, mock_collection_service
):
...
def test_get_pending_items_skips_existing_tags(
    service, mock_collection_repo, mock_repo, mock_note_repo
):
    # Setup: 2 Items
    # Item A: No tags
