...
from custom.cli.main import main, execute_pipeline
...
class TestCLIArgumentParsing:
    ...
    def test_required_input_argument_provided(self, tmp_path):
        ...
        test_args = ['prog', '--input', str(test_csv)]
    ...
    def test_custom_output_dir(self, tmp_path):
        ...
        test_args = ['prog', '--input', str(test_csv), '--output-dir', str(custom_output)]
    ...
    def test_fix_authors_flag_enabled(self, tmp_path):
        ...
        test_args = ['prog', '--input', str(test_csv), '--fix-authors']
    ...
    def test_nonexistent_input_file(self, tmp_path):
        ...
        test_args = ['prog', '--input', str(nonexistent_file)]
    ...
    def test_input_path_is_directory(self, tmp_path):
        ...
        test_args = ['prog', '--input', str(test_dir)]
...
class TestExecutePipeline:
    ...
    def test_execute_pipeline_conversion_only(self, tmp_path):
        ...
        with patch('custom.cli.main.CSVConverter') as mock_converter_class:
            ...
            assert exit_code == 0
            mock_converter.convert.assert_called_once_with(test_csv, output_dir)
